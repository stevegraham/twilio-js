...
describe('Twilio.Transcription', function() {
  var api;
  ...
  describe('.find', function() {
    ...
    it('can use twilio connect', function(done) {
      api = mock({
        ...
        connect:    true,
        resource:   'Transcriptions/TR90c6fc909d8504d45ecdb3a3d5b3556e',
        method:     'get',
        fixture:    'transcription'
      });

      Twilio.Transcription.find('TR90c6fc909d8504d45ecdb3a3d5b3556e', function(err, res) {
        api.done();
        done();
  ...
  describe('.all', function() {
    ...
    it('can use twilio connect', function(done) {
      api = mock({
        ...
        method:     'get',
        fixture:    'list_transcriptions'
      });

      Twilio.Transcription.all(function(err, res) {
        api.done();
        done();
      }, { accountSid: 'subaccount', connect: true });
    });
