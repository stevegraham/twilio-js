...
describe('Twilio.OutgoingCallerId', function() {
  var api;
  ...
  describe('.create', function() {
    ...
    it('can use twilio connect', function(done) {
      api = mock({
        ...
        connect:    true,
        resource:   'OutgoingCallerIds',
        method:     'post',
        fixture:    'connect_caller_id',
        statusCode: 201,
        body: {"PhoneNumber":"+12125551234"}
      });

      Twilio.OutgoingCallerId.create({"phoneNumber":"+12125551234","accountSid":"AC0000000000000000000000000000","connect":true}, function(err, res) {
        ...
        ["friendlyName"].forEach(function(el) { res[el] = 'foo' });
    ...
    it('can use a subaccount', function(done) {
      ...
      Twilio.OutgoingCallerId.create({"phoneNumber":"+12125551234","accountSid":"AC0000000000000000000000000000"}, function(err, res) {
        api.done();
        done();
      });
    });

    describe('on successfully creating a OutgoingCallerIds resource', function() {
      var api;
      ...
      it('returns an object representation of the API response', function(done) {
        ...
        Twilio.OutgoingCallerId.create({"phoneNumber":"+12125551234"}, function(err, res) {
    ...
    describe('on unsuccessfully creating a OutgoingCallerIds resource', function() {
      var api = mock({
        resource:   'OutgoingCallerIds',
        method:     'post',
        fixture:    'api_error',
      ...
      it('should return an error object', function(done) {
        Twilio.OutgoingCallerId.create({}, function(err, res) {
  ...
  describe('.find', function() {
    ...
    it('can use twilio connect', function(done) {
      api = mock({
        ...
        connect:    true,
        resource:   'OutgoingCallerIds/PN90c6fc909d8504d45ecdb3a3d5b3556e',
        method:     'get',
        fixture:    'caller_id'
      });

      Twilio.OutgoingCallerId.find('PN90c6fc909d8504d45ecdb3a3d5b3556e', function(err, res) {
        api.done();
        done();
  ...
  describe('.all', function() {
    ...
    it('can use twilio connect', function(done) {
      api = mock({
        ...
        resource:   'OutgoingCallerIds',
        method:     'get',
        fixture:    'list_caller_ids'
      });

      Twilio.OutgoingCallerId.all(function(err, res) {
        api.done();
        done();
      }, { accountSid: 'subaccount', connect: true });
    });
